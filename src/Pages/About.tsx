...
const skills = ['Html', 'css', 'javascript', 'typescript', 'scss', 'react', 'angular', 'node', 'express', 'mongo db', 'redux', 'ngrx', 'firebase', 'git', 'git hub', 'git lab', 'bootstrap', 'material ui', 'tailwind css', 'primefaces', 'responsive design', 'no sql', 'database design', 'database query'];
