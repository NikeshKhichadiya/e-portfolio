            ...
            <div className={`navbar ${!isTopScroll ? 'active' : ''}`}>
                ...
                <div className="left_side">
                    <ul className="nav_list desktop">
                        ...
                        <li className={`nav_item ${document.body.classList.contains('body') ? 'dark' : 'light'}`}>
                            <svg onClick={
                                ...
                                xmlns="http://www.w3.org/2000/svg" fill="#000000" height="800px" width="800px" version="1.1" id="Capa_1" viewBox="0 0 229.018 229.018">
                                <g>
                ...
                <div className="left_side_mobile mobile">
                    <li className={`nav_item ${document.body.classList.contains('body') ? 'dark' : 'light'}`}>
                        <svg onClick={
